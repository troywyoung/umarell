  ...
  return (
    <div style={{ margin: "16px 0" }}>
      ...
      <div style={{ padding: "14px 0 10px", borderTop: "1px solid rgba(255,255,255,0.12)" }}>
        ...
        <p style={{ fontSize: 26, fontWeight: 600, color: "#FFF", fontFamily: "'Silkscreen', cursive", letterSpacing: -0.8, margin: 0 }}>
          ...
          return (
            <>
              ...
              {recentPosts.length > 0 && (
                <div>
                  <div style={{ fontSize: 22, fontWeight: 600, color: "#FFF", fontFamily: "'Silkscreen', cursive", letterSpacing: 0.5, padding: "14px 4px 6px" }}>recent</div>
              ...
              {sortedCategories.map(([cat, items]) => (
                <div key={cat}>
                  <div style={{ fontSize: 22, fontWeight: 600, color: "#FFF", fontFamily: "'Silkscreen', cursive", letterSpacing: 0.5, textTransform: "lowercase", padding: "14px 4px 6px" }}>{cat}</div>
        ...
        {obs.status === "complete" && obs.thesis && obs.thesis !== "image" && (
          <div style={{ marginBottom: 12 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", margin: "0 0 8px" }}>
              <p style={{ fontSize: 22, fontWeight: 600, color: "#FFF", fontFamily: "'Silkscreen', cursive", letterSpacing: 0.5, margin: 0 }}>thesis</p>
              {!obs.parent_id && (
                <button
