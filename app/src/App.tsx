...
function HomeView({ observations, loading, onCapture, onSelect, onDelete }: {
  ...
  useEffect(() => {
    ...
    fetch(`https://api.pexels.com/v1/search?query=${["animals","people+wonderment","people+confusion","people+ecstasy","people+pain","factories","war"][Math.floor(Math.random()*7)]}&per_page=1&page=${page}&orientation=landscape`, {
