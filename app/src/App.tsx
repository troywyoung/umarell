  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" style={{ display: "block" }}>
      ...
      <path
        ...
        d="M48,52 C55,38 72,35 78,48 C84,61 74,78 58,80 C42,82 28,68 30,52 C32,36 48,24 64,28 C80,32 88,50 84,66 C80,82 62,90 44,86 C26,82 14,64 18,46 C22,28 42,16 60,22 C78,28 90,48 86,68 C82,88 62,96 40,90 C18,84 6,62 12,40 C18,18 42,8 64,16 C86,24 96,50 90,72 C84,94 60,102 36,94 C16,87 6,64 14,44 C22,24 46,14 66,22 C58,30 44,40 36,54 C28,68 32,84 46,88 C60,92 76,82 80,68 C84,54 76,38 62,36 C48,34 36,44 38,58 C40,72 54,78 66,74 C78,70 82,56 76,46 C70,36 54,34 44,42 C34,50 36,66 48,70 C60,74 70,64 68,52 C66,40 52,36 44,44 C36,52 40,66 52,68 C62,70 70,58 64,50 C58,42 46,44 44,52"
      />
    </svg>
  );
}
