# Add Idea: design control in admin page
...
do not worry about the preview window. list all of the exsting settings. in second column allow me to make changes. 
design the design section as if you would wan to use it
